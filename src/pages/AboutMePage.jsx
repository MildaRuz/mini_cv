...
export default function AboutMePage() {
  return (
    <div className="container-w flex flex-row justify-content-center container-mob shadow-lg shadow-stone-600/60">
      <div className="first-section py-20 print:py-10 print:px-6 print:w-2/5">
        <div>
          <div className="profile-img w-52 h-52 print:w-32 print:h-32">
          ...
          <div className="xl:mx-28 print:mx-6">
            <div>
              ...
              <div className="print:text-xs my-4">
                ...
                <div className="mb-center">
                  ...
                  >
                    ...
                    <svg
                      ...
                      height="20"
                      fill="currentColor"
                      className="bi bi-linkedin my-4 print-icons print:my-2"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="mb-center">
                  ...
                  >
                    ...
                    <svg
                      ...
                      height="20"
                      fill="currentColor"
                      className="bi bi-github hover:text-[#2dba4e] print-icons"
                      viewBox="0 0 16 16"
                    >
            ...
            {USER_DATA.skills.map((skill) => (
              <div className="my-4 print:my-1 print:text-xs" key={USER_DATA.skills.index}>
                <div>{skill}</div>
              </div>
            ))}
            ...
            {USER_DATA.basics.map((skill) => (
              <div className="my-4 print:my-1 print:text-xs" key={USER_DATA.basics.index}>
                <div>{skill}</div>
              </div>
            ))}
            ...
            {USER_DATA.languages.map((lang) => (
              <div className="my-4 print:my-1 print:text-xs" key={USER_DATA.languages.index}>
                <div>{lang}</div>
              </div>
            ))}
            <h2 className="text-xl mt-14 print:mt-5 my-4 print:text-base uppercase underline underline-offset-4">
            ...
            {USER_DATA.interests.map((hobbies) => (
              <div className="my-4 print:my-1 print:text-xs" key={USER_DATA.interests.index}>
                <div>{hobbies}</div>
              </div>
            ))}
          </div>
      ...
      <div className="second-section py-16 px-28 print:pb-12">
        <h2 className="text-xl print:text-base mb-center mt-16 print:mt-11 uppercase font-weight-500 underline underline-offset-4 print:mt-6">
        ...
        {USER_DATA.education.items.map((ed, index) => (
          <div key={index}>
            ...
            <div className="mt-6 print:mt-4 leading-7 print:text-xs/6">{ed.description}</div>
            {ed.activitiesAndSoc ? (
        ...
        <h2 className="text-xl print:text-base mt-16 print:mt-10 mb-center uppercase font-weight-500 underline underline-offset-4">
          working experience
        </h2>
        {USER_DATA.workingExperience.map((workEx) => (
          <div key={USER_DATA.workingExperience.index}>
            ...
            <div className="mt-6 leading-7 print:text-xs/6 print:mt-4">{workEx.description}</div>
          </div>
        ))}
      </div>
    </div>
